...
const duration = minutesToSeconds(23);
...
function merge(string, string1) {
    return string + string1;
}

const conjoined = merge("abra", "cadabra");
...
const humanYears = calculateDogyears(2);
...
function createDetailString(credentials) {
    return "Het beroep van " + credentials.firstName + " " + credentials.lastName + " is " + credentials.profession + ".";
...
const personalInfo = createDetailString({firstName: "Kees", lastName: "Klaasen", profession: "brandweerman"});
